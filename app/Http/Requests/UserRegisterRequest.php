...
class UserRegisterRequest extends FormRequest
{
    ...
    public function createRules()
    {
        $rules = [
            ...
            'country' => 'required|not_in:0|string|max:100|min:2|regex:/^[a-zA-Z0-9\s.,_&()\/#-]+$/',
    ...
    public function updateRules()
    {
        $rules = [
            ...
            'nic'    => 'required',
            'active' => 'in:0,1',
            'address_street_1' => 'required|string|max:100|min:5|regex:/^[a-zA-Z0-9\s.,_&()\/#-]+$/',
            'address_street_2' => 'nullable|string|max:100|regex:/^[a-zA-Z0-9\s.,_&()\/#-]+$/',
            'city' => 'required|string|max:100|min:3|regex:/^[a-zA-Z0-9\s.,_&()\/#-]+$/',
            'province' => 'required|string|max:100|min:5|regex:/^[a-zA-Z0-9\s.,_&()\/#-]+$/',
            // 'country' => 'required|string|max:100|min:2|regex:/^[a-zA-Z0-9\s.,_&()\/#-]+$/',
            'postalcode' => 'required|string|max:100|min:4|regex:/^[a-zA-Z0-9\s.,_&()\/#-]+$/'

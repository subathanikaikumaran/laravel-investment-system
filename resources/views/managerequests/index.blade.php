                ...
                <div class="page-body">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h5>Manage Withdraw Payment Details</h5>
                            ...
                            <div class="card-header-right">
                                <div class="dropdown-primary dropdown open">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdown-2" data-dropdown-in="fadeIn" data-dropdown-out="fadeOut">
                                        <a class="dropdown-item waves-light waves-effect" href="{{ route('manage.payreq.create') }}">Add New</a>
                        ...
                        <div class="card-block">
                            ...
                            {!! Form::open(['action' => 'WithdrawController@index','id'=>'search-form','class'=>'md-float-material form-material']) !!}
                            @csrf
                            <div class="row">

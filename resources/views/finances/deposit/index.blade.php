                ...
                <div class="page-body">
                     ...
                     <div class="card">
                        <div class="card-header">
                            ...
                            <span>All<code> Deposit </code>payment details</span>
                            <div class="card-header-right">
                                <div class="dropdown-primary dropdown open">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdown-2" data-dropdown-in="fadeIn" data-dropdown-out="fadeOut">
                                        <a class="dropdown-item waves-light waves-effect" href="{{ route('admin.initial.create') }}">Initial Payment</a>
                                        <div class="dropdown-divider"></div>
                                        <a class="dropdown-item waves-light waves-effect" href="{{ route('admin.deposit.create') }}">Add Payment</a>
                                        <!-- <div class="dropdown-divider"></div>
                        ...
                        <div class="card-block">
                            ...
                            {!! Form::open(['action' => 'PaymentController@indexDeposit','id'=>'search-form','class'=>'md-float-material form-material']) !!}
                            @csrf
                            <div class="row">
...
<script>
    ...
    $(document).ready(function() {
        ...
        var oTable = $('#tblpayment').DataTable({
            ...
            "lengthMenu": [10, 20, 30],
            ajax: {
                url: "{{ route('alldepositpaymentList') }}",
                data: function (d) {

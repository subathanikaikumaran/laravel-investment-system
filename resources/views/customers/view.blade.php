                                            ...
                                            <div class="card-header-right">
                                                <div class="dropdown-primary dropdown open">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdown-2" data-dropdown-in="fadeIn" data-dropdown-out="fadeOut">
                                                        <a class="dropdown-item waves-light waves-effect" href="{{ url('admin-customerinitial-create/'.$id) }}">Initial Payment</a>
                                                        ...
                                                        <div class="dropdown-divider"></div>
                                                        <a class="dropdown-item waves-light waves-effect" href="{{ url('start-discount-user/'.$id) }}">Discount Setting</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="col-xl-6 col-md-6">
                            <div class="row">
                                ...
                                <div class="col-xl-12 col-md-12">
                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                            <h5 class="m-b-10">Team Details -
                                                <?php echo isset($data['myTeamCount']) ? $data['myTeamCount'] : 0; ?>
                                                /6
                                            </h5>
                                        </div>
                                        <div class="card-block">

                ...
                <div class="page-body">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h5>Admin Users</h5>
                            <span>All admin<code> User </code>details</span>
                            <div class="card-header-right">
                                <div class="dropdown-primary dropdown open">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdown-2" data-dropdown-in="fadeIn" data-dropdown-out="fadeOut">
                                        <a class="dropdown-item waves-light waves-effect" href="{{ route('admin.user.create') }}">Add New</a>                                       
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="card-block">
                            ...
                            {!! Form::open(['action' => 'UserController@index','id'=>'search-form','class'=>'md-float-material form-material']) !!}
                            @csrf
                            <div class="row">

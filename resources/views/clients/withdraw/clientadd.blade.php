                        ...
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-header">
                                    <h5>Create New Withdraw Request</h5>
                                </div>
                                <div class="card-block">
                                    ...
                                    <br />
                                    @endif
                                    {!! Form::open(array('route' => 'withdraw.save','id'=>'frmprofile','method'=>'POST','class'=>'md-float-material form-material','enctype' => 'multipart/form-data')) !!}
                                    @csrf
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="form-group form-info">
                                                <input maxlength="10" required value="{{old('amount')}}" onkeypress="return isMaxamountKey(event)" type="text" name="amount" class="form-control">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            <a onclick="cancelConfirmation(event)" class="btn btn-blue-gray waves-effect waves-light" style="color: white;" href="{{ url('finance-summary') }}">Cancel<i class="icofont icofont-close-squared-alt"></i></a>
                                        </div>
                                    </div>
                                    </form>
                                </div>
